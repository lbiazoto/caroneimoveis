  	...
  	<tr>
    	<td width="49%" align="center" valign="top">
			<table width="95%" align="center" border="0" cellspacing="3" cellpadding="3" style="line-height:16px; text-align:left;">
				...
				<tr>
					<td colspan="2" align="left">Rua Dr. Jo�o Colin, 1285 - Sala 03 - Esquina com Rua Ararangu�</td>
				</tr>
				<tr>
                    <td colspan="2" align="left">Am�rica - 89204-001</td>
                </tr>
				<tr>
			...
			<?php
				if($_GET[tipo] == "enviar")
				{
					if($_POST[nome] != "" && $_POST[email] != "" && $_POST[mensagem] != "")
					{
						...
						mail("contato@caroneimoveis.com.br","Contato atrav�s do site - $_POST[assunto]",$texto, $from);
						*/
						$_POST[mensagem]=nl2br($_POST[mensagem]);
						$msgFinal = "
							<table align='left' cellpadding='3' cellspacing='3'>
								<tr bgcolor='#464646'>
									<th colspan='2' style='color:#93AD4C;'>Contato atrav�s do site - $_POST[assunto]</th>
								</tr>
								<tr>
						...
						sendMail($endereco_email_destino, $nome_email_padrao, $endereco_email_padrao, "Carone Im�veis", "Contato atrav�s do site - $_POST[assunto]", $msgFinal);
						mensagemRetorno("Seu formul�rio foi enviado com sucesso! <br> Estaremos entrando em contato o mais breve poss�vel!", "");
					}
				}
			?>
