			...
			<table width='100%' cellpadding='2' cellspacing='2'>
				<tr>
					<td width='70%' align='right'>
						<a href='index.php?modulo=clientes&acao=clienteinfo&tipo=imoveis&id=$id'>
							<div class='app_botao'><img src='css/images/icons/imoveis.png' border='0' class='icone_botao'> Imóveis</div>
						</a>
					</td>
		...
		print("
			<table width='100%' cellpadding='2' cellspacing='2'>
				<tr>
					...
					<td width='10%' align='right'>
						<a href='index.php?modulo=clientes&acao=clienteinfo&tipo=detalhes&id=$linha[id]'>
							<div class='app_botao'><img src='imagens/voltar.gif'> Voltar</div>
						</a>
					</td>
				</tr>
			</table>
			...
			<h1>Imóveis</h1>
		");
		devolveImoveisCliente($linha['id']);
	}
	elseif($tipo=="editar")
	{
		print("
