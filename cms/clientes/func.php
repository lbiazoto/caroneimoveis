...
function devolveImoveisCliente($idCliente)
{
	include("config.php");
	if (!conectaBancoDados())
		print("<center><strong>Nao foi possível estabelecer conexao com o Banco de Dados!</strong></center>");
			...
			if($num==0){
				print("
					<table width='100%' align='center' id='gradient-style-detalhes'>
						...
						<tr>
							<td align='left' colspan='6'>Nenhum imóvel encontrado.</td>
						</tr>
					</table>
				");
			}
				...
				print("
					<table width='100%' align='center' id='gradient-style-detalhes'>
						...
						while($linha = mysql_fetch_array($dados)){
							...
							if($linha['idSubCategoria']>0)
								$nomeSubCategoria = " / ".devolveInfoCampo("nome", "subcategorias", $linha['idSubCategorias']);
							else
								$nomeSubCategoria="";
							$localizacao=devolveInfoCampo("nome", "cidades", $linha['idCidade']).", ".devolveInfoCampo("nome", "regiao", $linha['idRegiao']).", ".devolveInfoCampo("nome", "bairros", $linha['idBairro']).", ".$linha['endereco'];
							...
							print("
								<tr>
									...
									<td align='left'>$nomeCategoria $nomeSubcategoria</td>
									<td align='left'>$localizacao</td>
