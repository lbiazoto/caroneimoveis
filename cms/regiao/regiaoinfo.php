...
if($modulo!="" && devolveUsuarioLogado() && $_SESSION['regiao'])
{
	...
	if($tipo=="detalhes" || $tipo=="")	$tituloH1="Região - Detalhes";
	elseif($tipo=="editar")	$tituloH1="Região - Editar";
	elseif($tipo=="removido")	$tituloH1="Região - Excluir";
	...
	if($modo=="editar")
	{
		...
		if($retorno)
			...
			$msg = "Ocorreu uma falha durante a atualização do Regiao!";
	}
