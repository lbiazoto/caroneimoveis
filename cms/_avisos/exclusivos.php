...
if($modulo!="" && devolveUsuarioLogado() && $_SESSION['avisos'])
{
	...
	devolveListaImoveisExclusivos($index, $mark, "WHERE deletado='0' AND exclusivo=1 $where ORDER BY $orderBy", "&dataFim=$dataFim&dataIni=$dataIni&titulo=$titulo&order=$order");
}
else
{
	print("
