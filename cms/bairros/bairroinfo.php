...
if($modulo!="" && devolveUsuarioLogado() && $_SESSION['bairros'])
{
	...
	$linha = devolveInfo("bairros", $id);

	if($linha[deletado]==1)
		$tipo="removido";

	if($tipo=="detalhes" || $tipo=="")	$tituloH1="Bairros - Detalhes";
	elseif($tipo=="editar")	$tituloH1="Bairros - Editar";
	elseif($tipo=="removido")	$tituloH1="Bairros - Excluir";
	...
	if($tipo=="removido")
	{
		print("<h1>Bairros - Excluir</h1>");
		devolveMensagem("Bairro removido com sucesso", $retorno);
	...
	if($modo=="editar")
	{
		...
		$retorno=editaBairro($idRegiao, $nome, $id, $_SESSION['idUsuario']);
		if($retorno)
			$msg = "Dados da Bairro atualizados com sucesso!";
		else
			$msg = "Ocorreu uma falha durante a atualização do Bairro!";
	}
	...
	{
		$regiao = devolveInfo("regiaos", $linha[idRegiao]);
		print("
			<table width='100%' cellpadding='2' cellspacing='2'>
				<tr>
					<td width='90%' align='right'>
						<a href='index.php?modulo=bairros&acao=bairroinfo&tipo=editar&id=$id' title='Editar'>
							<div class='app_botao'><img src='imagens/editar.png' border='0' class='icone_botao'> Editar</div>
						</a>
					</td>
					<td align='right'>
						<a href='index.php?modulo=bairros&acao=bairroinfo&tipo=&modo=remover&id=$id' onclick='return confirmaExclusao();' title='Excluir'>
	...
	{
		devolveMensagem("Bairro removido!", $retorno);
		print("<br><br><div align='center'><p>Selecione a opção desejada no menu ao lado.</p></div>");
		return false;
	}
	elseif($tipo=="editar")
	{
		print("
			<table width='100%' cellpadding='2' cellspacing='2'>
				<tr>
					<td align='right'>
						<a href='index.php?modulo=bairros&acao=bairroinfo&tipo=&id=$id' title='Ver detalhes'>
		...
		$linha = devolveInfo("bairros", $id);
		?>
		<form name="formCadastro" id="formCadastro" action="index.php?modulo=bairros&acao=bairroinfo&modo=editar&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
		  	<fieldset>
		    	<legend>Editar</legend>
		    	<table align="center" border="0" cellspacing="3" cellpadding="3">
					<tr id="combo">
						<th align="left">Regiao:</th>
						<td align="left"><?php montaSelectRegioes("idRegiao", $linha[idRegiao], false); ?>&nbsp;&nbsp;<a href="#" title="Adicionar Regiao"><img src="imagens/add.gif" alt="Adicionar Novo Bairro" border="0" onclick="hide('combo'); show('field'); novaRegiao.focus(); return false;"></a></td>
						<td valign="top">
					...
					<tr id="field">
						<th align="left">Regiao:</th>
						<td align="left"><input type="text" name="novaRegiao" id="novaRegiao" maxlength="100" onfocus="validaInputText(this, 'msgNovaRegiao', 'Nome da nova Regiao')"  onkeyup="validaInputText(this, 'msgNovaRegiao', 'Nome da nova Regiao')" style="width:228px;">&nbsp;&nbsp;<a href="#"><img src="imagens/cancelar.gif" alt="Cancelar" border="0" onclick="hide('field'); show('combo'); novaRegiao.value=''; return false;"></a></td>
						<td valign="top">
							<div id="msgNovaRegiao" class="none">
								<div class='imgMsg'><img src='css/images/obrigatorio.png'></div>
							</div>
						</td>
					</tr>
					<tr>
						<th>Nome:</th>
						<td><input type="text" name="nome" id="nome" maxlength="100" value="<?php echo $linha[nome]; ?>" onfocus="validaInputText(this,'msgNome','Nome do Bairro')"  onkeyup="validaInputText(this,'msgNome','Nome do Bairro')"></td>
						<td>
