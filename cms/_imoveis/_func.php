<?php
function cadastraImovel($referencia, $idCliente, $idCategoria, $idSubCategoria, $valor, $imagem, $idEstado, $opcaoCategoria, $listaSubCategoria, $listaSubCategoria2, $endereco, $descricaoCurta, $descricaoCompleta, $maisInformacoes, $destaque, $exclusivo, $dataTerminoExclusividade, $dataAviso, $composicao)
{
	include("./config.php");
	...
	{
		$comandoSql = "
			INSERT INTO imoveis (referencia, idCliente, idCategoria, idSubCategoria, valor, imagem, idEstado, idCidade, idRegiao, idBairro, endereco, descricaoCurta, descricaoCompleta, maisInformacoes, destaque, exclusivo, dataTerminoExclusividade, dataAviso, idUsuarioCadastro, dataCadastro)
			VALUES ('$referencia','$idCliente','$idCategoria','$idSubCategoria','$valor','$imagem','$idEstado','$opcaoCategoria','$listaSubCategoria','$listaSubCategoria2','$endereco','$descricaoCurta','$descricaoCompleta','$maisInformacoes','$destaque','$exclusivo','$dataTerminoExclusividade','$dataAviso','$_SESSION[idUsuario]',now());
		";
		debug($comandoSql);
...
function editaImovel($referencia, $idCliente, $idCategoria, $idSubCategoria, $valor, $imagem, $idEstado, $idCidade, $idRegiao, $idBairro, $endereco, $descricaoCurta, $descricaoCompleta, $maisInformacoes, $destaque, $exclusivo, $dataTerminoExclusividade, $dataAviso, $composicao, $codigo)
{
	include("./config.php");
	if (!conectaBancoDados())
		print("<center><strong>Nao foi possível estabelecer conexao com o Banco de Dados!</strong></center>");
	else
	{
		...
		$comandoSql = "
			UPDATE imoveis SET referencia='$referencia', idCliente='$idCliente', idCategoria='$idCategoria', idSubCategoria='$idSubCategoria', valor='$valor' $imagem, idEstado='$idEstado', idCidade='$idCidade', idRegiao='$idRegiao', idBairro='$idBairro',
			endereco='$endereco',descricaoCurta='$descricaoCurta', descricaoCompleta='$descricaoCompleta', maisInformacoes='$maisInformacoes', destaque='$destaque', exclusivo='$exclusivo' $datas, idUsuarioAtualizacao='$_SESSION[idUsuario]', dataAtualizacao=now() WHERE id=$codigo
		";
		debug($comandoSql);
		$dados = mysql_db_query($bancoDados, $comandoSql);
		if ($dados)
