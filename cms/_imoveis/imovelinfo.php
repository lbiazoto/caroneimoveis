...
if($modulo!="" && devolveUsuarioLogado() && $_SESSION['imoveis'])
{
	...
	if($modo=="editar")
	{
		...
		$retorno=editaImovel($tipoImovel, $referencia, $idCliente, $idCategoria, $idSubCategoria, $valor, $imagem, $estado, $opcaoCategoria, $listaSubCategoria, $listaSubCategoria2, $endereco, $localizacao_mapa, $descricaoCurta, $descricaoCompleta, $maisInformacoes, $destaque, $exclusivo, converteDataToMysql($dataTerminoExclusividade), converteDataToMysql($dataAviso), $composicao, $id);
		if($retorno)
