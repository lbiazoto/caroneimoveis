...
if($modulo!="" && devolveUsuarioLogado() && $_SESSION['complementos']){
	...
	if($tipo=="cadastrar")	$tituloH1="Informações Complementares (Terrenos / Áreas) - Cadastrar";
	elseif($tipo=="listar")	$tituloH1="Informações Complementares (Terrenos / Áreas) - Listar";
	...
	if($modo=="cadastrar"){
		...
		if($valorcampo){
			$arquivo = uploadImagem("$campoimagem", "../imoveis", 0, "");
			imageResize($arquivo, "../imoveis", "m_", "200", "200");
			imageResize($arquivo, "../imoveis", "g_", "800", "600");
			$arquivo = end(explode('/', $arquivo));
			unlink("../imoveis/$arquivo");
		}

		$retorno=cadastraInfoTerreno("terrenos", $id, $cep, $referencia, $complemento, $vizinho, $foneVizinho,
		$idade, $tipoArea, $ocupado, $chaves, $matricula, $circunscricao, $inscricaoImobiliaria, $contrato, $averbado, $conservacao, $pavimentacao, $horaVisita, $entrega, $estilo, $tipoForro, $placa, $posicaoSol, $classificacao,
		$indice, $venda, $locacao, $condominio, $tlu, $iptuIncra,
		$areaTotal, $areaTerreno, $areaPreservacao, $areaHectares,
		$metragemFrente, $metragemFundo, $metragemDireita, $metragemEsquerda,
		$finPoupanca, $finSaldoDevedor, $finValorPrestacao, $finParcelasPagas, $finParcelasRestantes, $finBanco, $finCondPagamento, $finPendencias, $finPermuta,
		$edificado,
		$obsTerreno, $zoneamento, $numPavimentos,
		$arquivo,
		$conContato, $conEmail, $conTelefone1, $conTelefone2, $conOutroContato, $conTelefoneOutro,
		...
		<table align="center" width="450" border="0" cellspacing="3" cellpadding="3">
			...
			<tr valign="baseline">
				<td nowrap align="center">
					<form style="width:450px;" name="formCadastro" id="formCadastro" action="index.php?modulo=complementos&acao=terrenos&modo=cadastrar&tipo=cadastrar<?php print("&id=$id");?>" method="post" enctype="multipart/form-data">
					  	<fieldset style="width:450px;">
					    	...
					    	<table align="center" border="0" cellspacing="3" cellpadding="3">
								...
								<tr>
									...
									<td align="left"><input type="text" name="vizinho" id="vizinho" maxlength="100"></td>
								</tr>
								<tr>
									<th align="left">Fone Vizinho:</th>
									<td align="left"><input type="text" name="foneVizinho" id="foneVizinho" maxlength="14" mascara="(##) ####-####" tipo="numerico"></td>
								</tr>
							</table>
						</fieldset>
						<br>
						...
						<fieldset style="width:450px;">
					    	...
					    	<table align="center" border="0" cellspacing="3" cellpadding="3">
								...
								<tr>
									...
									<td align="left"><input type="text" name="areaPreservacao" id="areaPreservacao" maxlength="50"></td>
								</tr>
								<tr>
									<th align="left">Hectares:</th>
									<td align="left"><input type="text" name="areaHectares" id="areaHectares" maxlength="50"></td>
								</tr>
							</table>
						</fieldset>
						<br>
						...
						<fieldset style="width:450px;">
					    	...
					    	<table align="center" border="0" cellspacing="3" cellpadding="3">
								<tr>
									...
									<td align="left"><textarea name="edificado" id="edificado" rows="3" style="height:120px;"></textarea></td>
								</tr>
							</table>
						</fieldset>
						<br>
						<fieldset style="width:450px;">
					    	...
					    	<table align="center" border="0" cellspacing="3" cellpadding="3">
								...
								<tr>
									...
									<td align="left"><input type="text" name="zoneamento" id="zoneamento" maxlength="100"></td>
								</tr>
								<tr>
									<th valign="top" align="left">N&ordm; Pavimentos:</th>
									<td align="left"><input type="text" name="numPavimentos" id="numPavimentos" maxlength="100"></td>
								</tr>
							</table>
						</fieldset>
						<br>
						...
						<fieldset style="width:450px;">
					    	...
					    	<table align="center" border="0" cellspacing="3" cellpadding="3">
								<tr>
									...
									<td align="left"><input type="text" name="conContato" id="conContato" maxlength="150"></td>
								</tr>
								<tr>
									<th valign="top" align="left">Email:</th>
									<td align="left"><input type="text" name="conEmail" id="conEmail" maxlength="150"></td>
								</tr>
								<tr>
									<th valign="top" align="left">Telefone 1:</th>
									<td align="left"><input type="text" name="conTelefone1" id="conTelefone1" maxlength="14" mascara="(##) ####-####" tipo="numerico"></td>
								</tr>
								<tr>
									<th valign="top" align="left">Telefone 2:</th>
									<td align="left"><input type="text" name="conTelefone2" id="conTelefone2" maxlength="14" mascara="(##) ####-####" tipo="numerico"></td>
								</tr>
								<tr>
									<th valign="top" align="left">Outro Contato:</th>
									<td align="left"><input type="text" name="conOutroContato" id="conOutroContato" maxlength="150"></td>
								</tr>
								<tr>
									<th valign="top" align="left">Telefone Outro:</th>
									<td align="left"><input type="text" name="conTelefoneOutro" id="conTelefoneOutro" maxlength="14" mascara="(##) ####-####" tipo="numerico"></td>
								</tr>
							</table>
						</fieldset>
						<br>
	...
	elseif($tipo=="listar" || $tipo=="")
	{
		...
		<table align="center" width="700" cellpadding="2" cellspacing="2">
			<tr>
				<td width="80%" align="center" valign="top">
					<form name="formPesquisa" id="formPesquisa" action="index.php?modulo=complementos&acao=terrenos&tipo=listar" method="post">
						<fieldset style='width:450px;'>
								...
								<tr>
							  		...
							  		<td align="left">
										<select id="idCategoria" name="idCategoria" style="width:95%;" onChange="DadosCategoria(this.value, 'subCategoriaXML', 'idSubCategoria', 'subCatOpcoes');">
											...
											<?php
												// seleciona categorias que não sejam apartamentos e residências
												montaSelect("categorias", $idCategoria, " AND id!=1 AND id!=2 "); ?>
										</select> *
									</td>
						 		</tr>
								<tr>
		...
		{
			$where.=" AND imo.idCategoria!=1 AND imo.idCategoria!=2 ";
		}
