...
if($modulo!="" && devolveUsuarioLogado() && $_SESSION['complementos'])
{
	...
	if($tipo=="cadastrar")	$tituloH1="Informações Complementares (Apartamentos) - Cadastrar";
	elseif($tipo=="listar")	$tituloH1="Informações Complementares (Apartamentos) - Listar";
	...
	if($modo=="cadastrar"){
		...
		$taxaMudanca=formataValor($taxaMudanca);
		$poolLocacao=formataValor($poolLocacao);
		$rendimento=formataValor($rendimento);

		$retorno=cadastraInfoApartamento("apartamentos", $id, $tipoImovel, $outroTipoImovel, $edificio, $andar, $apartamento, $bloco, $construtora, $numPavimentos, $aptosAndar, $cep, $referencia, $complemento, $taxaMudanca, $portariaFone, $admCondominio, $admCondominioFone,
		...
		$indice, $venda, $locacao, $poolLocacao, $rendimento, $condominio, $tlu, $iptuIncra, $valorLuz, $luzIndividual, $luzIdentificador, $valorAgua, $aguaIndividual, $aguaIdentificador,
		$areaTotal, $areaPrivativo, $areaGaragem, $areaComum,
		...
		$acabamentos, $pintura, $piso, $mobilia, $anuncio, $anuncioPontosFortes
		);
		if($retorno==true){
    		print("
		...
		<table align="center" width="450" border="0" cellspacing="3" cellpadding="3">
			...
			<tr valign="baseline">
				<td nowrap align="center">
					<form style="width:450px;" name="formCadastro" id="formCadastro" action="index.php?modulo=complementos&acao=apartamentos&modo=cadastrar&tipo=cadastrar<?php print("&id=$id");?>" method="post" enctype="multipart/form-data">
								...
								<tr>
									...
									<td align="left">
										<select name="tipoImovel" id="tipoImovel">
											...
											<option value="Madeira">Alvenaria</option>
											<option value="Mista">Alvenaria</option>
						...
						<fieldset style="width:450px;">
					    	...
					    	<table align="center" border="0" cellspacing="3" cellpadding="3">
								...
								<tr>
									...
									<td align="left"><input type="text" name="edificio" id="edificio" maxlength="150"></td>
								</tr>
						 		<tr>
									<th align="left">Apartamento:</th>
									<td align="left"><input type="text" name="apartamento" id="apartamento" maxlength="30"></td>
								</tr>
						 		<tr>
									<th align="left">Andar:</th>
									<td align="left"><input type="text" name="andar" id="andar" maxlength="30"></td>
								</tr>
								<tr>
									<th align="left">Bloco:</th>
									<td align="left"><input type="text" name="bloco" id="bloco" maxlength="30"></td>
								</tr>
								<tr>
									<th align="left">Construtora:</th>
									<td align="left"><input type="text" name="construtora" id="construtora" maxlength="150"></td>
								</tr>
								<tr>
									<th align="left">N&ordm; Pavimentos:</th>
									<td align="left"><input type="text" name="numPavimentos" id="numPavimentos" maxlength="30"></td>
								</tr>
								<tr>
									<th align="left">Ap&acute;tos. por Andar:</th>
									<td align="left"><input type="text" name="aptosAndar" id="aptosAndar" maxlength="30"></td>
								</tr>
								<tr>
									<th align="left">Taxa Mudan&ccedil;a:</th>
									<td align="left"><input type="text" name="taxaMudanca" id="taxaMudanca" maxlength="20" tipo="numerico" mascara="###.###.###.###,##" orientacao="esquerda"></td>
								</tr>
								<tr>
									<th align="left">Portaria Fone:</th>
									<td align="left"><input type="text" name="portariaFone" id="portariaFone" maxlength="14" mascara="(##) ####-####" tipo="numerico"></td>
								</tr>
								<tr>
									<th align="left">Adm. Condom&iacute;nio:</th>
									<td align="left"><input type="text" name="admCondominio" id="admCondominio" maxlength="100"></td>
								</tr>
								<tr>
									<th align="left">Fone:</th>
									<td align="left"><input type="text" name="admCondominioFone" id="admCondominioFone" maxlength="14" mascara="(##) ####-####" tipo="numerico"></td>
								</tr>
							</table>
						</fieldset>
						<br>
						...
						<fieldset style="width:450px;">
					    	...
					    	<table align="center" border="0" cellspacing="3" cellpadding="3">
								...
								<tr>
									...
									<td align="left"><input type="text" name="areaPrivativo" id="areaPrivativo" maxlength="50"></td>
								</tr>
								<tr>
									<th align="left">Garagem:</th>
									<td align="left"><input type="text" name="areaGaragem" id="areaGaragem" maxlength="50"></td>
								</tr>
								<tr>
									<th align="left">Comum.:</th>
									<td align="left"><input type="text" name="areaComum" id="areaComum" maxlength="50"></td>
								</tr>
							</table>
						</fieldset>
						<br>
						<fieldset style="width:450px;">
					    	...
					    	<table align="center" border="0" cellspacing="3" cellpadding="3">
								...
								<tr>
									...
									<td align="left"><input type="text" name="poolLocacao" id="poolLocacao" maxlength="20" tipo="numerico" mascara="###.###.###.###,##" orientacao="esquerda"></td>
								</tr>
								<tr>
									<th align="left">Rendimento:</th>
									<td align="left"><input type="text" name="rendimento" id="rendimento" maxlength="20" tipo="numerico" mascara="###.###.###.###,##" orientacao="esquerda"></td>
								</tr>
								<tr>
	...
	elseif($tipo=="listar" || $tipo=="")
	{
		...
		<table align="center" width="700" cellpadding="2" cellspacing="2">
			<tr>
				<td width="80%" align="center" valign="top">
					<form name="formPesquisa" id="formPesquisa" action="index.php?modulo=complementos&acao=apartamentos&tipo=listar" method="post">
						<fieldset style='width:450px;'>
								...
								<tr>
							  		...
							  		<td align="left">
										<select id="idCategoria" name="idCategoria" style="width:95%;" onChange="DadosCategoria(this.value, 'subCategoriaXML', 'idSubCategoria', 'subCatOpcoes');">
											...
											<?php
												// seleciona categorias que não sejam terrenos e residências
												montaSelect("categorias", $idCategoria, " AND id!=1 AND id!=3 "); ?>
										</select> *
									</td>
						 		</tr>
								<tr>
		...
		{
			$where.=" AND imo.idCategoria!=1 AND imo.idCategoria!=3 ";
		}
