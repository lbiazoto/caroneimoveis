...
function fileBrowserCallBack(field_name, url, type, win) 
{
	...
	win.open('newsletter/newsLetterUpload.php', 'ImageBrowser', 'width=300,height=200,scrollbars=yes,status=yes,location=no,resizable=yes,dependent');
	// Insert new URL, this would normaly be done in a popup
	//win.document.forms[0].elements[field_name].value = "jujuba";
	//win.opener.document.formUpload.procurar.value
}
