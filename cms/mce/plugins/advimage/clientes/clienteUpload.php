<?php
	...
	if($tipo=="upload")
	{
		...
		else
		{
			...
			$destino = "$enderecoCompleto/clientes/imagens/";
				while(file_exists("../../../../clientes/imagens/$nomeReal"))
				{
				...
				if (move_uploaded_file($nomeTemp, "../../../../clientes/imagens/$nomeReal"))
				{
...
<body id="advimage">
<form method="POST" name="formUpload" action="clienteUpload.php?tipo=upload" enctype="multipart/form-data">
