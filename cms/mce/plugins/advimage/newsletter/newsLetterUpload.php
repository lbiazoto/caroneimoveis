<?php
	...
	if($tipo=="upload")
	{
		...
		else
		{
			...
			$destino = "$enderecoCompleto/newsletter/imagens/";
				while(file_exists("../../../../newsletter/imagens/$nomeReal"))
				{
				...
				if (move_uploaded_file($nomeTemp, "../../../../newsletter/imagens/$nomeReal"))
				{
...
<body id="advimage">
<form method="POST" name="formUpload" action="newsLetterUpload.php?tipo=upload" enctype="multipart/form-data">
