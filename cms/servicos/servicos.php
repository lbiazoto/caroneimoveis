...
if($modulo!="" && devolveUsuarioLogado() && $_SESSION['servicos'])
{
	...
	if($tipo=="cadastrar")	$tituloH1="Serviços - Cadastrar";
	elseif($tipo=="listar")	$tituloH1="Serviços - Listar";
			...
			<fieldset>
		    	...
		    	<table align="center" border="0" cellspacing="3" cellpadding="3">
					...
					<tr>
						...
						<td align="left"><input type="text" name="nome" id="nome" maxlength="100" onfocus="validaInputText(this, 'msgNome', 'Entre com o nome do responsável.')"  onkeyup="validaInputText(this, 'msgNome', 'Entre com o nome do responsável.')"></td>
						<td>
					...
					<tr>
						...
						<td align="left"><textarea name="descricao" id="descricao" onfocus="validaInputText(this, 'msgDescricao', 'Descreva o serviço.')"  onkeyup="validaInputText(this, 'msgDescricao', 'Descreva o serviço.')"></textarea></td>
						<td valign="top">
					...
					<tr>
						...
						<td align="left"><input type="text" name="endereco" id="endereco" maxlength="150" onfocus="validaInputText(this, 'msgEndereco', 'Endereço (Cidade, Rua , Nº).')"  onkeyup="validaInputText(this, 'msgEndereco', 'Endereço (Cidade, Rua , Nº).')"></td>
						<td>
