DELETE FROM backup;
INSERT INTO backup VALUES ( '1', 'Teste backup', '2009-09-10 15:54:27', '0', '-1', 'backup/backup/backup-10-09-2009-15-54-27.sql', '', '');
DELETE FROM cases;
...
333', '14e2e2960d4412975b9bde3b89a882ef589.txt', '1', '1', '0', '2009-09-10 15:56:07', '-1', '2009-09-08 15:12:24');
DELETE FROM submenu;
